...
import static tvr.learn.java5.static_ex.MyStaticUtil.MyConstants;
import static tvr.learn.java5.static_ex.MyStaticUtil.myStaticMethod;
...
public class StaticImport {
    public static void main(String... args){
        StaticImport j5f=new StaticImport();
